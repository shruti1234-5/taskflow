...
export default function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-indigo-500/10 via-transparent to-purple-600/10 dark:from-black dark:via-gray-900 dark:to-black">
      <div
